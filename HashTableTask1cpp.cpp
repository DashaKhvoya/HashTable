...
void TestHashFunction(size_t (*Hash)(Pair*)) {
...
int main() {
	TestHashFunction(HashFunction_1);
	TestHashFunction(HashFunction_2);
	TestHashFunction(HashFunction_3);
	TestHashFunction(HashFunction_4);
	TestHashFunction(HashFunction_5);
	TestHashFunction(HashFunction_6);
	TestHashFunction(HashFunction_7);
  return 0;
}
